...
ВЫБОР ВЕРДИКТА — следуй СТРОГО:
✅ МОЖНО — только если решение явно допустимо нормативами БЕЗ существенных оговорок и ограничений
❌ НЕЛЬЗЯ — если прямо запрещено нормативами
⚠️ УСЛОВНО — если допустимо ТОЛЬКО при выполнении определённых условий (например, при соблюдении расстояний, наличии защиты и т.п.)
⛔ НЕ СООТВЕТСТВУЕТ — если решение технически возможно, но НЕ отвечает нормативным требованиям по безопасности или функциональности

КРИТИЧЕСКИ ВАЖНО:
- НИКОГДА не ставь ✅ МОЖНО если в следующем абзаце объясняешь, почему это не работает или не соответствует требованиям
- НИКОГДА не ставь ✅ МОЖНО если решение требует существенных доработок
- Если сомневаешься между ✅ и ⚠️ — выбирай ⚠️ УСЛОВНО
- Если решение «поставить можно, но нормативам не отвечает» — это всегда ⛔ НЕ СООТВЕТСТВУЕТ
